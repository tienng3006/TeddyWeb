	...
	<div class="container">
		<div class="content">
			...
			<div class="total">
				...
				<div class="total_right">
					VAT (0%):
					<c:out value="${sessionScope.myCartTotal * 0}" /> k
				</div>
				<div class="clearfix"></div>
				<div class="total_right">
					Phải trả: 
					<c:out
						value="${sessionScope.myCartTotal + (sessionScope.myCartTotal * 0)}" /> k
				</div>
				<div class="clearfix"></div>
			</div>
			<div class="clearfix"></div>
		...
		<div class="contact">
			...
			<div class="col-md-6 contact-top">
				<h3>Info</h3>
				<p>Chúng tôi cam kết tất cả sản phẩm trong cửa hàng đều là sản phẩm rẻ, đẹp, chất lượng</p>
				<p>Cửa hàng của chúng tôi luôn đặt uy tín, niềm tin khách hàng lên hàng đầu</p>
				<ul class="social ">
					<li><span><i> </i>24 Võ Oanh, Bình Thạnh ,Tp Hồ Chí Minh
					</span></li>
					<li><span><i class="down"> </i>+84942182077</span></li>
					<li><a href="mailto:lenaahgage.got7@gmail.com"><i class="mes">
						</i>lenaahgase.got7@gmail.com.com</a></li>
				</ul>
			</div>
			<div class="col-md-6 contact-top">
				<!--  
